...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-32 sm:pt-20">
        <motion.div
        ...
        >
          ...
          >
            ...
            <span className="block">
              Tools for {" "}<span className="relative inline-block w-[240px] sm:w-[280px] md:w-[300px] lg:w-[340px]">
